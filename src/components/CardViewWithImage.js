  ...
  render() {
    ...
    const content = (
      <View style={container}>
        {this.props.imageComponent === undefined ? (
          <Image
            resizeMode={"cover"}
            style={{
              width: this.props.imageWidth,
              height: this.props.imageHeight,
              borderRadius: this.props.roundedImage
                ? this.props.roundedImageValue
                : undefined,
              alignSelf: "center",
    ...
    return (
      <View
        style={{
          ...
          shadowOffset: {
            width:
              Platform.OS === "ios" ? this.props.style.shadowOffsetWidth : 0,
            height:
              Platform.OS === "ios" ? this.props.style.shadowOffsetWidth : 0,
          },
